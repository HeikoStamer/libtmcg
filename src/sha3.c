...
/* I modified and removed some lines (e.g. test cases) of the file "sha3.c"
   to make the C++ compiler happy. The result still remains in public domain.
   June 1st, 2018. Heiko Stamer */
...
static void
sha3_Update(sha3_context *priv, const uint8_t *bufIn, size_t len)
{
    sha3_context *ctx = priv;
